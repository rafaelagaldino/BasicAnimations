...
class ViewController: UIViewController {
    ...
    private func animateClouds() {
        let options: UIView.AnimationOptions = [.curveEaseInOut,
                                                .repeat,       // A animação se repetirá para sempre
                                                .autoreverse]  // Incluir essa opção sempre com .repeat. Ela reproduz repetidamente a animação para frente e depois para trás.
